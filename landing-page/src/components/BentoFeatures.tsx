                ...
                >
                    ...
                    <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        >
                            ...
                            <div className="px-3 pb-3">
                                <div className="rounded-lg overflow-hidden border border-slate-100">
                                    <img src="/screenshots/board-view.png" alt="Kanban Board" className="w-full h-auto block" loading="lazy" />
                                </div>
                            </div>
                        </motion.div>
                        ...
                        <div className="lg:w-1/3 flex flex-col gap-4">
                            <SmallCard
                                ...
                                image="/screenshots/timeline-view.png"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        >
                            ...
                            <div className="px-3 pb-3">
                                <div className="rounded-lg overflow-hidden border border-slate-100">
                                    <img src="/screenshots/list-view.png" alt="List View" className="w-full h-auto block" loading="lazy" />
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="px-3 pb-3">
                                <div className="rounded-lg overflow-hidden border border-slate-100">
                                    <img src="/screenshots/reports-view.png" alt="Reports" className="w-full h-auto block" loading="lazy" />
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="px-3 pb-3">
                                <div className="rounded-lg overflow-hidden border border-slate-100">
                                    <img src="/screenshots/board-view.png" alt="Team Collaboration" className="w-full h-auto block" loading="lazy" />
                                </div>
                            </div>
                        </motion.div>
                    </div>
